...
let url = `/api/pacientes/?page=${pagina}`;
  ...
  // Nota: ya no se filtra localmente. El backend retorna el resultado global para la búsqueda.
...
// filtrarLocal ya no se usa para la búsqueda global (se filtra en backend).
